...
-- 权限
INSERT INTO sys_permission (id, code, name, description, created_time, updated_time) VALUES ('1', '1', '照片管理', '照片管理', NOW(), NOW());
INSERT INTO sys_permission (id, code, name, description, created_time, updated_time) VALUES ('2', '2', '原图浏览', '原图浏览', NOW(), NOW());

-- 角色
INSERT INTO sys_role (id, name, description, created_time, updated_time) VALUES ('1', 'ADMIN', '管理员', NOW(), NOW());
INSERT INTO sys_role (id, name, description, created_time, updated_time) VALUES ('2', 'VIEWER', '访客', NOW(), NOW());
...
-- 用户
INSERT INTO sys_user (id, username, password, status, created_time, updated_time) VALUES ('1', 'root', '$2a$10$jndgC.sZFv0volqxQeXdk.NGN.K7Smrko/5UtP33pPVUcQdP0604a', 1, NOW(), NOW());
INSERT INTO sys_user (id, username, password, status, created_time, updated_time) VALUES ('2', 'viewer', '$2a$10$jndgC.sZFv0volqxQeXdk.NGN.K7Smrko/5UtP33pPVUcQdP0604a', 1, NOW(), NOW());
